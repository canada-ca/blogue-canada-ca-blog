...
<div class="wb-frmvld row">
  <form id="contact-dto" action="acknowledgement.html" method="post" class="gc-referrer mrgn-tp-lg col-md-8 gc-font-2019" data-gc-referrer='{ "acknowledgement": "acknowledgement.html" }' netlify>
    <input name="referer" value="" data-wb-jsonmanager='{
        "name": "referer",
        "extractor": [
            { "interface": "referer", "path": "externalReferer" }
        ]
    }' data-wb-json='{
        "url": "#[referer]/externalReferer",
        "type": "val"
    }'>
    <input type="hidden" value="contact-dto" name="formId">
