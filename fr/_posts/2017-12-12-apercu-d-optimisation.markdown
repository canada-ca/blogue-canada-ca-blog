...
<img class="img-responsive" alt="Comment nous optimisions le site Canadapointca - des détails suivent" src="{{ site.baseurl }}/{{ page.lang }}/images/process/optimization-process-FR.png">
