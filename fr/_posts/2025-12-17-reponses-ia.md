...
{% include components/gc-complex-img.html
  ...
  caption="<b>Capture d’écran de la page &laquo;&nbsp;Se connecter à un dossier ou un compte en ligne du gouvernement du Canada&nbsp;&raquo;.</b><br>Une page montrant les options d’ouverture de session et une fenêtre contextuelle invitant les utilisateurs à essayer le nouveau service de Réponses IA."
