...
<figure class="wb-mltmd wb-init video">
	<video poster="{{ site.baseurl }}/{{ page.lang }}/images/taxes-impots/payroll-content-video-poster.jpg" title="contenu de la page Web des retenues sur la paie">
		<source type="video/mp4" src="{{ site.baseurl }}/{{ page.lang }}/images/taxes-impots/payroll-content-fr.mp4" />
	</video>
...
<figure>
<img class="img-responsive" alt="Capture d'écran montrant la page Retenues sur la pei avant et après et indiquant les différences." src="{{ site.baseurl }}/{{ page.lang }}/images/taxes-impots/payroll-before-after-fr.png">
</figure>
...
<figure>
<img class="img-responsive" alt="Capture d'écran montrant la page TPS / TVH avant et après et indiquant les différences." src="{{ site.baseurl }}/{{ page.lang }}/images/taxes-impots/gsthst-before-after-fr.png">
</figure>
