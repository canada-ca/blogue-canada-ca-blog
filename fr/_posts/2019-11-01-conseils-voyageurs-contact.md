...
date:   2019-11-01
description: "À l’hiver 2019, le Bureau de l’expérience Canada.ca (BEC) a travaillé de concert avec des équipes d’Affaires mondiales Canada (AMC) et de l’Agence du revenu du Canada (ARC) sur deux différents projets d’optimisation du contenu&nbsp;: «&nbsp;Conseils aux voyageurs et avertissements&nbsp;» et «&nbsp;Communiquer avec l’ARC&nbsp;»."
layout: post
...
* [Résumé de la recherche&nbsp;: Conseils aux voyageurs et avertissements]( {{ "/resumes-recherche/conseils-voyageurs-resume-recherche.html" | prepend: site.urlalt[ page.language ] }} )
* [Résumé de la recherche&nbsp;: Communiquer avec l’<abbr title="Agence du revenu du Canada">ARC</abbr>]( {{ "/resumes-recherche/arc-contactez-nous-resume-recherche.html" | prepend: site.urlalt[ page.language ] }} )
