...
<img class="img-responsive mrgn-bttm-lg" src="{{ site.baseurl }}/{{ page.lang }}/images/PO/The-Honourable-Scott-Brison.png" width="750px" alt="Une photo de l'honorable Scott Brison" />
