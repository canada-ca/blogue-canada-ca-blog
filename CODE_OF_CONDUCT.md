# Contributor Covenant Code of Conduct for the `Blog prototype of Canada.ca` project

([Français](#Code-de-conduite-pour-le-projet-prototype-de-blogue-de-Canada.ca))

Contributors to repositories hosted in [`Prototypes-GC`](https://github.com/gc-proto/) are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
# Code de conduite pour le projet `Prototype de blogue de Canada.ca`

([English](#Contributor-Covenant-Code-of-Conduct-for-the-blog-prototype-of-Canada.ca-project))

Les contributeurs aux dépôts hébergés dans [`Prototypes-GC`](https://github.com/gc-proto/) sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
